...
Web server written with Node.js to support the iOS Tinfinity application.
...
NOTE: To use MongoDB Geopacital tools, the users position must be set as a 2dindex: 
```
